...
<head>
    ...
    color: #333; font-size:18px; line-height: 32px; border-radius:10px; float:left; cursor:pointer; }
...
제33조(분쟁의 해결) "회사"는 분쟁이 발생하였을 경우에 "이용자"가 제기하는 정당한 의견이나 불만을 반영하여 적절하고 신속한 조치를 취합니다. 다만, 신속한 처리가 곤란한 경우에 "회사"는 "이용자"에게 그 사유와 처리일정을 통보합니다. 
                ...
                <div class="btn_fr">
                    <input type="checkbox" id="ck_item1" name="ck_item"> <label for="ck_item1">약관에 동의</label><br><br>
